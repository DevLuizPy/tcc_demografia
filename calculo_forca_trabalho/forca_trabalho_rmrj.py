...
# Tabela de municípios e arquivos de censo
...
for ano, arquivo in arquivos_censos.items():
    ...
    # Filtro dos municípios e população relevante
...
df_final.to_excel("forca_trabalho_rmrj.xlsx", index=False)
print("Arquivo 'forca_trabalho_rmrj.xlsx' criado com sucesso.")
