...
for ano, arquivo in arquivos_censos.items():
    ...
    # Filtrando apenas o estado do Rio de Janeiro (código 33)
    df_filtrado = df_censo[
        (df_censo[f'GEO1_BR{ano}'] == 33) &
        (df_censo['AGE'] > 24) &
...
# Exportar
df_final.to_excel("forca_trabalho_estado_rj.xlsx", index=False)
print("Arquivo 'forca_trabalho_estado_rj.xlsx' criado com sucesso.")
