...
# Código do estado do Rio de Janeiro
codigo_estado_rj = 33
estatisticas_lista = []
...
for arquivo, coluna_codigo in arquivos_censos.items():
    ...
    # Filtro para o estado do Rio de Janeiro
    df_censo = df_censo[df_censo[coluna_codigo] == codigo_estado_rj]
...
estatisticas_agregadas.to_excel("estatisticas_renda_agregada_rio_de_janeiro.xlsx", index=False)

print("Cálculo concluído e arquivo salvo como 'estatisticas_renda_agregada_rio_de_janeiro.xlsx'.")
